# =============================================================================
# PROJECT: Mini GPT From Scratch using TensorFlow & Transformer Architecture
# AUTHOR : Shubham Pawar
# DESCRIPTION:
# Educational implementation of a GPT-style Decoder-Only Transformer including
# tokenization, embeddings, masked self-attention, next-word prediction, and
