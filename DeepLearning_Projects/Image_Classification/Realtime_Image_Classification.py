# ===========================================================
# Project Name : Real-Time Image Classification using CNN
# Description  : A computer vision application that performs
#                real-time image classification using a webcam
#                and a pre-trained MobileNetV2 Convolutional
#                Neural Network (CNN) model trained on the
#                ImageNet dataset.
#
# Features:
...
#   - Displays predicted object label with confidence score
#   - Supports continuous live detection
#
# Technologies Used:
#   - Python
#   - OpenCV
